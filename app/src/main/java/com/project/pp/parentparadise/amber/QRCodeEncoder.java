...
public final class QRCodeEncoder {
    ...
    private void encodeQRCodeContents(String data, Bundle bundle, String type) {
        if (type.equals(QRCodeContents.Type.TEXT)) {
            if (data != null && data.length() > 0) {
                contents = data;
                displayContents = data;
                title = "Text";
            }
        } else if (type.equals(QRCodeContents.Type.EMAIL)) {
            data = trim(data);
            if (data != null) {
        ...
        } else if (type.equals(QRCodeContents.Type.PHONE)) {
            data = trim(data);
            if (data != null) {
                contents = "tel:" + data;
        ...
        } else if (type.equals(QRCodeContents.Type.SMS)) {
            data = trim(data);
            if (data != null) {
                contents = "sms:" + data;
                displayContents = PhoneNumberUtils.formatNumber(data);
        ...
        } else if (type.equals(QRCodeContents.Type.CONTACT)) {
            if (bundle != null) {
        ...
        } else if (type.equals(QRCodeContents.Type.LOCATION)) {
            if (bundle != null) {
